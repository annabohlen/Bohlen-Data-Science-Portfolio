...
Tab 1 - Data
Users can upload their own dataset or choose a sample dataset. Once they see a preview of the dataset, they can select a target columnn.
...
To run this app locally:
  1. Clone the respository:
     git clone https://github.com/annabohlen/MLStreamlitApp.git
      cd MLStreamlitApp
